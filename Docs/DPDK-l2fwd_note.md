...
> references
> [DPDK official documentation: L2 Forwarding Sample Application (in Real and Virtualized Environments)](https://doc.dpdk.org/guides/sample_app_ug/l2_forward_real_virtual.html)
